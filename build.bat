...
set depLibs=sfml-graphics-s.lib sfml-window-s.lib sfml-system-s.lib opengl32.lib winmm.lib user32.lib advapi32.lib gdi32.lib

set compilerFlags=/nologo /DSFML_STATIC /Fe:CLogButBetter.exe /MTd /GR- /Gm- /EHsc /Od /Oi /FC /Zi /WX /W4 /wd4100 /I..\src\ /I..\deps\include\
